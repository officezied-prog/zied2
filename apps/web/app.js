...
const T = {
ar: {
  n_home:"الرئيسية",n_disc:"اكتشف",n_brands:"العلامات",n_camp:"الحملات",n_out:"التواصل",n_agents:"غرفة العمليات",n_social:"السوشيال",n_legal:"العقود",n_price:"الأسعار",
  mode_checking:"جارٍ الاتصال…",mode_online:"متصل · Claude",mode_online_off:"متصل · وضع القواعد",mode_offline:"وضع تجريبي · Offline",
  hero_eye:"منصة التسويق عبر المؤثرين · إندونيسيا",hero_h1:"ربط العلامات التجارية بصنّاع المحتوى الموثّقين في إندونيسيا",hero_sub:"اكتشاف المؤثرين، كشف الحسابات الوهمية، مطابقة الحملات، العقود والمدفوعات — في منصة واحدة.",hero_cta1:"اكتشف المؤثرين ←",hero_cta2:"اعرض الأسعار",
  c_creators:"مؤثر موثّق",c_brands:"علامة تجارية",c_campaigns:"حملة",c_er:"متوسط التفاعل",team_eye:"غرفة العمليات — للفريق فقط",team_h:"منسّق واحد يقود 21 وكيلاً متخصصاً في 5 مجموعات",feat_eye:"ماذا تفعل المنصة",
  f1t:"اكتشاف المؤثرين",f1d:"بحث وفلترة 120+ مؤثر بالمنصة والنيش والفئة والمدينة مع درجة احتيال لكل حساب",f2t:"كشف الاحتيال",f2d:"تحليل نسبة المتابَعين، قفزات النمو، التعليقات العامة وأنماط التفاعل المشتراة قبل الدفع",f3t:"مطابقة الحملات",f3d:"خوارزمية موزونة: النيش، المنصة، الفئة، التفاعل، الثقة والمدينة — مع خطة محسّنة للميزانية",f4t:"رسائل التواصل",f4d:"قوالب بثلاث لغات، تعبئة تلقائية، تخصيص ذكي، وإرسال ومتابعات مجدولة",f5t:"العقود والضمان",f5d:"عقود إندونيسية جاهزة للتوقيع، ومدفوعات محمية بالضمان حتى اعتماد المحتوى",f6t:"إدارة السوشيال",f6d:"تقويم محتوى لصفحات عملائك، جدولة ونشر على إنستغرام وتيك توك ولينكدإن",
...
en: {
  n_home:"Home",n_disc:"Discover",n_brands:"Brands",n_camp:"Campaigns",n_out:"Outreach",n_agents:"Ops room",n_social:"Social",n_legal:"Contracts",n_price:"Pricing",
  mode_checking:"Connecting…",mode_online:"Online · Claude",mode_online_off:"Online · rule mode",mode_offline:"Demo · Offline",
  hero_eye:"Influencer marketing platform · Indonesia",hero_h1:"Connecting brands with verified creators in Indonesia",hero_sub:"Creator discovery, fake-account detection, campaign matching, contracts and payments — in one platform.",hero_cta1:"Discover creators →",hero_cta2:"See pricing",
  c_creators:"verified creators",c_brands:"brands",c_campaigns:"campaigns",c_er:"avg engagement",team_eye:"Operations room — team only",team_h:"One orchestrator leads 21 specialists in 5 groups",feat_eye:"What the platform does",
  f1t:"Creator discovery",f1d:"Search and filter 120+ creators by platform, niche, tier and city with a fraud score per account",f2t:"Fraud detection",f2d:"Follow ratio, growth spikes, generic comments and bought-engagement patterns analysed before you pay",f3t:"Campaign matching",f3d:"Weighted algorithm: niche, platform, tier, engagement, trust and city — with a budget-optimised plan",f4t:"Outreach messages",f4d:"Templates in three languages, auto-fill, smart personalisation, scheduled sending and follow-ups",f5t:"Contracts & escrow",f5d:"Indonesian contracts ready to sign, and payments held in escrow until the content is approved",f6t:"Social management",f6d:"Content calendars for your clients' pages, scheduled and published to Instagram, TikTok and LinkedIn",
...
id: {
  n_home:"Beranda",n_disc:"Temukan",n_brands:"Brand",n_camp:"Kampanye",n_out:"Outreach",n_agents:"Ruang operasi",n_social:"Sosial",n_legal:"Kontrak",n_price:"Harga",
  mode_checking:"Menghubungkan…",mode_online:"Online · Claude",mode_online_off:"Online · mode aturan",mode_offline:"Demo · Offline",
  hero_eye:"Platform influencer marketing · Indonesia",hero_h1:"Menghubungkan brand dengan kreator terverifikasi di Indonesia",hero_sub:"Penemuan kreator, deteksi akun palsu, pencocokan kampanye, kontrak dan pembayaran — dalam satu platform.",hero_cta1:"Temukan kreator →",hero_cta2:"Lihat harga",
  c_creators:"kreator terverifikasi",c_brands:"brand",c_campaigns:"kampanye",c_er:"rata-rata engagement",team_eye:"Ruang operasi — khusus tim",team_h:"Satu orkestrator memimpin 21 spesialis dalam 5 grup",feat_eye:"Apa yang dilakukan platform",
  f1t:"Penemuan kreator",f1d:"Cari & filter 120+ kreator berdasarkan platform, niche, tier, kota dengan skor fraud per akun",f2t:"Deteksi fraud",f2d:"Rasio follow, lonjakan growth, komentar generik, dan pola engagement palsu dianalisis sebelum bayar",f3t:"Pencocokan kampanye",f3d:"Algoritma berbobot: niche, platform, tier, engagement, trust, kota — dengan rencana anggaran optimal",f4t:"Pesan outreach",f4d:"Template 3 bahasa, isi otomatis, personalisasi cerdas, pengiriman dan follow-up terjadwal",f5t:"Kontrak & escrow",f5d:"Kontrak Indonesia siap tanda tangan, pembayaran ditahan escrow sampai konten disetujui",f6t:"Manajemen sosial",f6d:"Kalender konten untuk halaman klien Anda, dijadwalkan dan ditayangkan ke Instagram, TikTok, LinkedIn",
...
const OFFLINE_AGENTS = [
  ...
  ["halal", "清", "spec", { ar: "وكيل التوافق الحلال", en: "Halal Compliance", id: "Kepatuhan Halal" }, { ar: "يراجع المنتجات والمحتوى من ناحية التوافق الحلال قبل الإطلاق.", en: "Reviews products and content for halal compliance before launch.", id: "Meninjau produk dan konten dari sisi kepatuhan halal sebelum tayang." }],
...
const D = {
  ...
  async agents() { if (online()) { const r = await api("/agents"); S.agents = r.items; S.brain = r.mode; } return { items: S.agents }; }, // 403 for non-staff: the offline roster stays as the fallback
...
async function offlineAgent(agent, message, context = {}) {
  ...
  if (only ? only === "halal" : want.halal) {
    run.plan.push(`清 ${L3(A("halal").name)}`); step("halal", "get_brand", { brandId: brand?.id }, { name: brand?.name });
    const prods = brand?.products?.length ? brand.products.join(LANG === "ar" ? "، " : ", ") : "—";
    sections.push(LANG === "ar"
      ? `**الحكم: يحتاج تحقّق** — ${brand?.name || "العلامة"} · ${prods}\n1. شهادة BPJPH: الرقم والانتهاء وهل تغطي هذا المنتج تحديدًا.\n2. المكوّنات: الجيلاتين، المستحلبات E471، الإيثانول، الإنزيمات الحيوانية، القرمز، الجلسرين.\n3. الادّعاءات: «حلال» تحتاج شهادة سارية.\n4. المحتوى: مراجعة حساب المؤثر وجدولة تراعي رمضان.`
      : LANG === "id"
      ? `**Putusan: PERLU VERIFIKASI** — ${brand?.name || "brand"} · ${prods}\n1. Sertifikat BPJPH: nomor, masa berlaku, cakupan produk.\n2. Bahan: gelatin, E471, etanol, enzim hewani, karmin, gliserin.\n3. Klaim: "halal" butuh sertifikat berlaku.\n4. Konten: tinjau feed kreator, jadwalkan sekitar Ramadan.`
      : `**Verdict: VERIFY** — ${brand?.name || "the brand"} · ${prods}\n1. BPJPH certificate: number, expiry, and whether it covers this product.\n2. Ingredients: gelatin, E471, ethanol, animal enzymes, carmine, glycerin.\n3. Claims: "halal" needs a valid certificate.\n4. Content: review the creator's feed, schedule around Ramadan.`);
  }
...
const ALL_PAGES = ["home", "discover", "brands", "campaigns", "outreach", "agents", "social", "legal", "pricing"];
const STAFF_PAGES = ["agents"];                       // the operations room: our own team, never a customer
const ROLE_PAGES = {
  admin: ALL_PAGES,                                   // Rabith staff
  brand: ["home", "discover", "campaigns", "social", "legal", "pricing"],
  creator: ["home", "legal", "pricing"],
};
const isStaff = () => S.user?.role === "admin";
const allowedPages = () => (S.user ? ROLE_PAGES[S.user.role] || ["home", "pricing"] : ALL_PAGES.filter((p) => !STAFF_PAGES.includes(p)));
...
function applyRoleUI() {
  const allowed = allowedPages(), staff = isStaff();
  $$("[data-staff]").forEach((el) => { el.hidden = !staff; });        // ops room surfaces
  $$(".nav-tab").forEach((b) => { b.hidden = !allowed.includes(b.dataset.page); });
  document.body.classList.toggle("is-staff", staff);
  const cur = (location.hash || "#home").slice(1);
  if (!allowed.includes(cur)) goPage("home");
}
...
function goPage(id) {
  if (STAFF_PAGES.includes(id) && !isStaff()) { if (location.hash) history.replaceState(null, "", "#home"); id = "home"; }
...
async function boot() {
  ...
  goPage(PAGES[INITIAL_HASH] ? INITIAL_HASH : "home");
}
...
/* ══════════════════════════ 16. INIT ══════════════════════════ */
const INITIAL_HASH = (location.hash || "#home").slice(1); // captured before any redirect, so a staff deep link survives sign-in
